...
<head>
    ...
    <link rel="stylesheet" href="<?=base_url()?>/assets/admin/css/dore.light.blue.css" />
...
<script src="<?=base_url()?>/assets/admin/js/vendor/jquery-3.3.1.min.js"></script>
...
<script src="<?=base_url()?>/assets/admin/js/vendor/jquery.contextMenu.min.js"></script>
<script src="<?=base_url()?>/assets/admin/js/dore.script.js"></script>
<script src="<?=base_url()?>/assets/admin/js/scripts.single.theme.js"></script>
