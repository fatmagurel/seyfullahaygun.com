        ...
        <div class="row">
            ...
            <?php }?>
			  ...
			  <div class="card-header card-header-primary">
                  <h4 class="card-title">Hakkımda Ayarları</h4>
                  <p class="card-category">Hakkımda Güncelleme Alanı</p>
                </div>
                <div class="card-body">
					<div class="col-12">
                    ...
                    <div class="card mb-4">
                        <div class="card-body ">
						    <form class="form-horizontal" method="post" action="<?=base_url()?>admin/Hakkimda/guncelle/<?=$veriler[0]->Id?>">
							...
							<script src="<?=base_url()?>/ckeditor/ckeditor.js"></script>
								...
								<div class="card">
									<div class="position-relative">
										...
										<a type="button" href="<?=base_url()?>admin/Hakkimda/resim_yukle/<?=$veriler[0]->Id?>" class="btn btn-danger badge badge-pill badge-secondary position-absolute badge-top-right">DEĞİŞTİR</a> 
